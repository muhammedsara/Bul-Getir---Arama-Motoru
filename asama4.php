...
if(isset($_POST['kelime1'])) {
    ...
    for($x=0;$x<$urlsayi;$x++){
        ...
        for($e=0;$e<$kelimesayi;$e++)
        {
            ...
            $kelimeler1[$e]=ara($stringUrl3,$dizi[$e]);
            echo  " ",$dizi[$e],"  ";

            $esanlam1=esanlami($dizi[$e]);
            $es = explode (",",$esanlam1);
            $esanlam1=replace_tr($es[0]);

            $kelimeler2[$e]=ara($stringUrl3,$esanlam1);
            echo  " ",$esanlam1,"  ";


            $kelimeler[$e]=$kelimeler1[$e]+$kelimeler2[$e];
        ...
        for($i=1;$i<$d1+1;$i++){
            ...
            for($r=0;$r<$kelimesayi;$r++)
            {
                ...
                $kelimeler1[$r]=ara($stringUrl2,$dizi[$r]);
                echo  " ",$dizi[$r],"  ";

                $esanlam2=esanlami($dizi[$r]);
                $es = explode (",",$esanlam2);
                $esanlam2=replace_tr($es[0]);

                $kelimeler2[$e]=ara($stringUrl2,$esanlam2);
                echo  " ",$esanlam2,"  ";
            ...
            if($d2==0){
                ...
                for($g=1;$g<$d2+1;$g++){
                    ...
                    for($f=0;$f<$kelimesayi;$f++)
                    {
                        ...
                        $kelimeler1[$f]=ara($stringUrL4,$dizi[$f]);
                        echo  " ",$dizi[$f],"  ";
                        // echo  " --> ",$dizi_url[$u],$deneme[$i],'<br>';

                        $esanlam3=esanlami($dizi[$f]);
                        $es = explode (",",$esanlam3);
                        $esanlam3=replace_tr($es[0]);

                        $kelimeler2[$e]=ara($stringUrl4,$esanlam3);
                        echo  " ",$esanlam1,"  ";
...
function esanlami($kelime)
{

    $data = array();

    ///https://www.dersimiz.com/yakin-ve-es-anlamli-anlamdas-kelimeler-sozlugu.asp?q=kelime

    $url = "https://www.dersimiz.com/yakin-ve-es-anlamli-anlamdas-kelimeler-sozlugu.asp?q=".$kelime;
...
//echo $sonuc;
    ...
    strip_tags($sonuc);
    $sayac = 0;
//strip_tags($stringUrl);
    $eskelime=" ";
    if ((strpos($sonuc2, $aranacak)) !== false){

        $index = strpos($sonuc2, $aranacak);

        $sonu = substr($sonuc2, $index);

        $index2 = strpos($sonu, "<strong>",45);
        $index3 = strpos($sonu, "</strong>",45);
        $esanlamli_kelime= substr($sonu, $index2,$index3-$index2);
        $eskelime=$esanlamli_kelime;
